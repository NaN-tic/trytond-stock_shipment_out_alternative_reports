...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-stock_shipment_out_alternative_reports',
    download_url='https://github.com:nantic/trytond-stock_shipment_out_alternative_reports.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-stock_shipment_out_alternative_reports.git'
    },
    classifiers=[
